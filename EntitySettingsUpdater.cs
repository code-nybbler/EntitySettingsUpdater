...
namespace EntitySettingsUpdater
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Entity Settings Updater"),
        ExportMetadata("Description", "Allows bulk updating of entity settings"),
    ...
    public class EntitySettingsUpdater : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new EntitySettingsUpdaterControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public EntitySettingsUpdater()
        {
